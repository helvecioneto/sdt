...
def translate_brb(df):
    ...
    column = ['id', 'timestamp', 'year', 'day', 'min', 'temp_sfc', 'humid', 'press', 'prec',
              'ws10_avg', 'wd10_avg', 'wd10_std', 'ws10_std']
    meteorological = meteorological.reindex(columns=column)

    mux = pd.MultiIndex.from_tuples([('id', '', ''), ('timestamp', '', ''), ('year', '', ''), ('day', '', ''), ('min', '', ''),
                                     ('temp_sfc', 'C', 'tmo_ventil'), ('humid', '%', 'tmo_ventil'), (
                                         'press', 'mb', 'tmo_ventil'), ('prec', 'mm', 'tmo_ventil'),
